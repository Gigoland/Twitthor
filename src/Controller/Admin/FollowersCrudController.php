...
class FollowersCrudController extends AbstractCrudController
{
    /**
     * @return string
     */
    ...
    public function configureCrud(Crud $crud): Crud
    {
        return $crud
            ...
            ->setPageTitle(Crud::PAGE_INDEX, 'My Followers')
            ->setEntityLabelInPlural('Followers')
            ->setEntityLabelInSingular('Follower')
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            BooleanField::new('isFollowing', 'Following'),
