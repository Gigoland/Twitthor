...
class FollowingCrudController extends AbstractCrudController
{
    /**
     * @return string
     */
    ...
    public function configureCrud(Crud $crud): Crud
    {
        return $crud
            ...
            ->setPageTitle(Crud::PAGE_INDEX, 'Following')
            ->setEntityLabelInPlural('Following')
            ->setEntityLabelInSingular('Following')
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            BooleanField::new('isFollower', 'Follow me'),
    ...
    public function createIndexQueryBuilder(
        ...
        $qb
            ...
            ->andWhere($alias[0] . '.isFollowing = 1')
