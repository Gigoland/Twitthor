 ...
 */
final class Version20220329211458 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE follower (id INT AUTO_INCREMENT NOT NULL, wallet_eth VARCHAR(55) DEFAULT NULL, wallet_sol VARCHAR(55) DEFAULT NULL, is_favorite TINYINT(1) NOT NULL, create_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', update_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tw_user (id INT AUTO_INCREMENT NOT NULL, tw_user_id VARCHAR(55) NOT NULL, tw_username VARCHAR(22) NOT NULL, tw_name LONGTEXT NOT NULL, tw_is_verified TINYINT(1) NOT NULL, create_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', update_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
