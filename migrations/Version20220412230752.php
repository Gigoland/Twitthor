 ...
 */
final class Version20220412230752 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tw_api (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, consumer_key VARCHAR(255) DEFAULT NULL, consumer_secret VARCHAR(255) DEFAULT NULL, access_token VARCHAR(255) DEFAULT NULL, access_token_secret VARCHAR(255) DEFAULT NULL, bearer_token VARCHAR(255) DEFAULT NULL, account_id BIGINT DEFAULT NULL, account_name VARCHAR(255) DEFAULT NULL, INDEX IDX_ABA9CC42A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tw_user (id INT AUTO_INCREMENT NOT NULL, tw_account_id BIGINT NOT NULL, tw_username VARCHAR(22) NOT NULL, tw_name LONGTEXT NOT NULL, tw_is_verified TINYINT(1) NOT NULL DEFAULT 0, create_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', update_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, tw_account_id BIGINT DEFAULT NULL, tw_username VARCHAR(22) DEFAULT NULL, wallet_eth VARCHAR(55) DEFAULT NULL, wallet_sol VARCHAR(55) DEFAULT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, create_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', update_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
