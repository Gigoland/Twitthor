...
const setTwApiSettingActive = function() {
  ...
  document.querySelectorAll('.js-switch-isactive').forEach(el => el.style.display = 'none');
  ...
  setTimeout(() => {
    ...
    .then(data => {
      ...
      document.querySelectorAll('.js-switch-isactive').forEach(el => el.style.display = 'block');
...
(function() {
  ...
  if (document.querySelector('.js-switch-isactive')) {
    document.querySelectorAll('.js-switch-isactive').forEach(el => el.addEventListener('change', setTwApiSettingActive));
  }
})();
